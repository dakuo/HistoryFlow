...
function historyflow(svg, width, height, dataset, revision_index_start, revision_index_end, timescale_flag) {
	...
	*/
	var revisions = dataset.revisions; // TODO 
...
historyflow.prototype.transitionFilter = function() {
	console.log( this.reivions);
}
